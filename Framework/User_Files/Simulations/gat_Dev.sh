...
JAVA_OPTS="-DHOST=$2 -DITERATIONS=$3 -DRAMP=$4 -DSIMULATION_1=$5 -DSIMULATION_2=$6 -DSIMULATION_3=$7 -DSIMULATION_4=$8" $GATLING_HOME/bin/gatling.sh -s $1 -on $ON -rd $SCENARIO-SIMULATION_1_$SIMULATION_1:SIMULATION_2_$SIMULATION_2:SIMULATION_3_$SIMULATION_3:Iterations_$ITERATIONS
